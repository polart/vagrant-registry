# -*- coding: utf-8 -*-
# Generated by Django 1.11b1 on 2017-03-11 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boxes_permissions', models.CharField(choices=[('R', 'Pull'), ('RW', 'Pull/Push')], default='RW', max_length=2)),
            ],
        ),
        migrations.AddField(
            model_name='user',
